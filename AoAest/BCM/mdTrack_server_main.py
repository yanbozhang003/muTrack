...
eng.addpath(r'/home/project6/work/muTrack/AoAest/BCM/matlab/mdTrack/')
...
if __name__ == "__main__":
    ...
    while True:
        if len(DICT_SANIT['CSI']) > 0:
            ...
            aoaEstMat = eng.mdTrack_func(CSI_matrix_amp_pass,CSI_matrix_pha_pass,pha_diff_rx12_pass,pha_diff_rx13_pass)
