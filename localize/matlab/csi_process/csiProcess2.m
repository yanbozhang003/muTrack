...
tr_idx = 5;
AP_idx = 5;
FILE = ['../data/0125/dbg_mDtrack_AoA_2G_20M_AP',num2str(AP_idx),'_tr',num2str(tr_idx),'.pcap'];% capture file
...
save(['../data/0125/dbg_mDtrack_AoA_2G_20M_AP',num2str(AP_idx),'_tr',num2str(tr_idx),'.mat'],'CSI_cell');
